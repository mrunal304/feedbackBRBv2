  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#C0001A] via-[#8B0000] to-[#3D0000] flex items-center justify-center px-4 font-nunito">
      ...
      >
        ...
        <p className="text-[1.2rem] md:text-[1.2rem] font-nunito font-semibold text-[#777777] leading-[1.7] mb-6 max-w-[420px]">
        ...
        <div className="w-full bg-[#FAFAFA] border border-[#EEEEEE] rounded-[12px] p-4 mb-8">
          <p className="text-[1.05rem] md:text-[1.1rem] text-[#8B0000] font-nunito font-bold italic">
        ...
        <Button
          ...
          className="w-full bg-[#8B0000] hover:bg-[#a51d1d] text-white font-nunito font-black text-[1.7rem] md:text-[1.1rem] h-auto py-3 rounded-[12px] flex items-center justify-between px-6 transition-all duration-200"
        >
          <Home size={20} />
